...
const AVAILABLE_CSV_FILES = [
  ...
  '/golf_olympians.csv',
  '/rugby_olympians.csv',
  '/rowing_olympians.csv',
  '/volleyball_olympians.csv',
  '/water_polo_olympians.csv',
  '/wrestling_olympians.csv',
  '/snowboarding_olympians.csv',
  '/soccer_olympians.csv',
  '/softball_olympians.csv',
  '/speedskating_olympians.csv',
  '/surfing_olympians.csv',
  '/swimming_olympians.csv',
  '/taekwondo_olympians.csv',
  '/tennis_olympians.csv',
  '/triathlon_olympians.csv',
  '/gymnastics_olympians.csv',
  '/ice_hockey_olympians.csv',
  '/shooting_olympians.csv',
  '/skateboarding_olympians.csv',
  ...
  '/para_shooting_paralympians.csv',
  '/para_snowboarding_paralympians.csv',
  '/para_swimming_paralympians.csv',
  '/para_track_and_field_paralympians.csv',
  '/paratriathlon_paralympians.csv',
  '/wheelchair_basketball_paralympians.csv',
  '/wheelchair_fencing_paralympians.csv',
  '/wheelchair_rugby_paralympians.csv',
  '/wheelchair_tennis_paralympians.csv',
  '/sled_hockey_paralympians.csv',
];
